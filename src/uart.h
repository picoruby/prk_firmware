...
void c_bi_uart_rx_init(mrb_vm *vm, mrb_value *v, int argc);
void c_bi_uart_tx_init(mrb_vm *vm, mrb_value *v, int argc);
void c_bi_uart_putc_raw(mrb_vm *vm, mrb_value *v, int argc);
void c_bi_uart_getc(mrb_vm *vm, mrb_value *v, int argc);
...
#define UART_INIT() do { \
  ...
  \
  mrbc_define_method(0, mrbc_class_Keyboard, "bi_uart_rx_init",  c_bi_uart_rx_init);  \
  mrbc_define_method(0, mrbc_class_Keyboard, "bi_uart_tx_init",  c_bi_uart_tx_init);  \
  mrbc_define_method(0, mrbc_class_Keyboard, "bi_uart_putc_raw", c_bi_uart_putc_raw); \
  mrbc_define_method(0, mrbc_class_Keyboard, "bi_uart_getc",     c_bi_uart_getc);     \
} while (0)
